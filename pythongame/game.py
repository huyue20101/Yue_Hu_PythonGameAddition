...
while player is False:
    ...
    if player_lives = 0
        print ("Game Over, Do you want to top up? 1CAD,5CAD,10CAD")
        a = input("choose how much money you want to top up")
        while True:
            a = input("Choose how much money you want to top up or press Q to quit：")
            if a == 'Q':
                exit()
            try:
                a = int(a)
